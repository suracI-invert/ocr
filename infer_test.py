...
from src.utils.transforms import Resize, SwinAugmenter, ToTensor
...
if __name__ == "__main__":
    ...
    trainer = Trainer(accelerator="gpu", precision="16-mixed", logger=False)
    ...
    pd.DataFrame(
        {"filename": filenames, "prediction": predictions, "probability": probabilities}
