...
class OCRDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        if self.test_data:
            ...
            return {"img": img, "filename": basename(self.paths[idx])}
        ...
        tokenized_labels = self.tokenizer.encode(
            self.labels[idx], padding=True, max_length=self.max_target_length, return_tensor=True
        )
